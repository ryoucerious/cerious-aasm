...
describe('defaultRouteGuard', () => {
  ...
  it('should redirect to /server in Electron environment', async () => {
  ...
  it('should redirect to /server when authentication is disabled', async () => {
  ...
  it('should redirect to /server when user is authenticated', async () => {
    utilityService.getPlatform.and.returnValue('Web');
